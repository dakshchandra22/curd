...
if (isset($_POST['done'])) {
    ...
    $q = " UPDATE `crudtable` SET `id`='$id',`username`='$username',`phone`='$phone',`email`='$email',`gender`='$gender',`photo`='$destifile' WHERE id=$id";
    ...
    <div class="col-lg-6 m-auto">
        ...
        <form method="post">
            ...
            <div class="card">
                ...
                <button class="btn btn-success" type="submit" name="done" autocomplete="off"> Submit </button><br>
